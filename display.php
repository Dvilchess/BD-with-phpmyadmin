...
$sql = "SELECT rut_pextraviada, direccion, nombre, ropa, hora, rasgos, edad FROM personaextraviada";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
  // arroja la informacion de cada fila
  ...
  echo "No hay personas extraviadas registradas";
}
$conn->close();
?>
